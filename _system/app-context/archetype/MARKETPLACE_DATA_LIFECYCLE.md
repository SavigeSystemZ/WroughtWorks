...
App-specific context for the marketplace data lifecycle, part of the `fullstack-marketplace` archetype context pack
(`_system/archetypes/fullstack-marketplace.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- The listing and order lifecycle states.
- Data retention for transactions.
- PII and payment-data handling.
- Export and account-closure handling.
