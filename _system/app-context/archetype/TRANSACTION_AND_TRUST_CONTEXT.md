...
App-specific context for transactions and trust, part of the `fullstack-marketplace` archetype context pack
(`_system/archetypes/fullstack-marketplace.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- The transaction and payment flow.
- Escrow and payout handling.
