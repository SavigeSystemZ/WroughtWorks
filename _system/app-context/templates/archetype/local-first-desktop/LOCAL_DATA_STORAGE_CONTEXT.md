...
App-specific context for local data storage, part of the `local-first-desktop` archetype context pack
(`_system/archetypes/local-first-desktop.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- Where app data is stored on disk and in what format.
- The storage schema and how it is versioned.
- Schema migration handling on upgrade.
