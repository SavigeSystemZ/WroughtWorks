...
App-specific context for the data dashboard shape, part of the `data-dashboard` archetype context pack
...
- The refresh and latency expectations.
- The key views the dashboard provides.
