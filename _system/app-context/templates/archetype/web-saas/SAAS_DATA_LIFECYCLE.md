...
App-specific context for the SaaS data lifecycle, part of the `web-saas` archetype context pack
(`_system/archetypes/web-saas.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- How records are created, updated, and soft-deleted.
- The data retention and purge policy.
- Backup and restore behavior.
- Export and account-deletion handling.
