...
App-specific context for privacy and compliance, part of the `background-check-or-osint-app` archetype context pack
(`_system/archetypes/background-check-or-osint-app.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- The privacy laws and regulations that apply.
