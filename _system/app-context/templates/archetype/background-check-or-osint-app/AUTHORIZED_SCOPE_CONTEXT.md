...
App-specific context for the authorized scope, part of the `background-check-or-osint-app` archetype context pack
(`_system/archetypes/background-check-or-osint-app.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- What subjects or targets are in scope and the authorization or consent basis.
- What is explicitly out of scope.
- How authorization is verified before any lookup.
- The stop conditions that halt an investigation.
