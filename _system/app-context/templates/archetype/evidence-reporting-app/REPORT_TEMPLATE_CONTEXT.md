...
App-specific context for the report templates, part of the `evidence-reporting-app` archetype context pack
(`_system/archetypes/evidence-reporting-app.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- The report types and their sections.
- The formatting and branding rules.
- Required vs optional content.
- How report templates are versioned.
