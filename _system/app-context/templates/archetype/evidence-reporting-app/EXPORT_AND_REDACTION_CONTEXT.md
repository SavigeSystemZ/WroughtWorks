...
App-specific context for export and redaction, part of the `evidence-reporting-app` archetype context pack
(`_system/archetypes/evidence-reporting-app.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- The export formats.
- The redaction rules and what must always be redacted.
- How redaction is verified before release.
- Distribution controls on exported reports.
