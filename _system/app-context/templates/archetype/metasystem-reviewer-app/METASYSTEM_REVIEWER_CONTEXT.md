...
App-specific context for the metasystem-reviewer product shape, part of the `metasystem-reviewer-app` archetype context pack
(`_system/archetypes/metasystem-reviewer-app.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- What systems the app reviews.
- The intended operators.
- The review scope and its limits.
