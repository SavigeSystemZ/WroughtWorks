...
App-specific context for the scoring rubric, part of the `metasystem-reviewer-app` archetype context pack
...
- The weighting across dimensions.
- The score thresholds and what each band means.
