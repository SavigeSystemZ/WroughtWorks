...
App-specific context for mobile privacy, part of the `mobile-apk` archetype context pack
(`_system/archetypes/mobile-apk.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- What data the app collects and where it goes.
- The privacy-policy and data-safety disclosures.
- On-device vs server-side processing.
- Data-deletion and opt-out handling.
