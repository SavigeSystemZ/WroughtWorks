...
App-specific context for the mobile app shape, part of the `mobile-apk` archetype context pack
(`_system/archetypes/mobile-apk.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- The app's purpose and its primary screens.
- The minimum and target Android API levels.
- The navigation model.
- Offline behavior and degraded-connectivity handling.
