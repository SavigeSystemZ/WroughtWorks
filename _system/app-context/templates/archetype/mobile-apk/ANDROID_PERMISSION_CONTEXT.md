...
App-specific context for Android permissions, part of the `mobile-apk` archetype context pack
(`_system/archetypes/mobile-apk.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- Each permission the app requests and why it is needed.
- The runtime-permission request UX.
- The minimization rationale for the permission set.
- App behavior when a permission is denied.
