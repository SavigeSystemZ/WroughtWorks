...
App-specific context for privacy and export, part of the `finance-budgeting-app` archetype context pack
(`_system/archetypes/finance-budgeting-app.md`). Project-specific truth, derived from
`PRODUCT_BRIEF.md` and `app/`.

## Fill this in

- Where financial data lives and who can see it.
- Encryption and access control for that data.
- The export formats supported.
- Account-deletion and data-portability handling.
